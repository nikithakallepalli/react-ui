    ...
    handleSearch = () => {
        ...
        axios.post(url, payload)
            .then(result => {
                ...
                this.setState({searchRecipe: [...this.state.searchRecipe, data.recipes.slice(0, 4)], search: true});
                this.setState({searchRecipe: data.recipes.slice(0, 4), search: true}, () => {
                });
        ...
        return (
            <div className="content-wrapper">
                <div className="content-header bakimage">
                    ...
                    <div className={"pantry-recipe-grid RecipeGrid " + (this.state.search ? 'show' : 'hidden')}>
                        <section className="pantry-grid-header">
                            <h4 className="grid-title h4-text primary-dark font-bold">64 Recipes that match your 10 Ingredients</h4>
                        </section>
