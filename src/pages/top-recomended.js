...
import placeHolder from './../image1.jpeg';
                                ...
                                <section className="flex-row card-list">
                                    ...
                                    <span className="text ">Original</span></span>
                                                <div className="recipe-card-img-wrapper">
                                                    <img alt="5-Ingredient Sugar Cookies Recipe" src={placeHolder} className="recipe-card-img placeholder" data-pin-description="5-Ingredient Sugar Cookies with Granulated Sugar, Salted Butter, Granulated Sugar, Large Eggs, All-Purpose Flour, Baking Soda." width="220" height="220"/>
                                                    <img alt="5-Ingredient Sugar Cookies Recipe" src={placeHolder} className="recipe-card-img full" data-pin-description="5-Ingredient Sugar Cookies with Granulated Sugar, Salted Butter, Granulated Sugar, Large Eggs, All-Purpose Flour, Baking Soda." width="220" height="220"/>
