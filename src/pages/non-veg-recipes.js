...
import nonVeg from './../non-veg.jfif';
    ...
    componentDidMount() {
        ...
        axios.post(url, {"diet": "non-vegetarian"})
            .then(response => {
                ...
                this.setState({nonVegRecipes: data.recipes.slice(0, 8)});
                                ...
                                <section className="flex-row card-list">
                                    ...
                                    <span className="text ">Original</span></span>
                                                <div className="recipe-card-img-wrapper">
                                                    <img alt="5-Ingredient Sugar Cookies Recipe" src={nonVeg} className="recipe-card-img placeholder" data-pin-description="5-Ingredient Sugar Cookies with Granulated Sugar, Salted Butter, Granulated Sugar, Large Eggs, All-Purpose Flour, Baking Soda." width="220" height="220"/>
                                                    <img alt="5-Ingredient Sugar Cookies Recipe" src={nonVeg} className="recipe-card-img full" data-pin-description="5-Ingredient Sugar Cookies with Granulated Sugar, Salted Butter, Granulated Sugar, Large Eggs, All-Purpose Flour, Baking Soda." width="220" height="220"/>
